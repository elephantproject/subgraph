# Elephant Dex Subgraph - Elephant Swap Subgraph #

yarn codegen
yarn build
yarn deploy

[Elephant Dex](https://elephant.ac/) is a decentralized protocol for automated token exchange on Harmony.
...
Contains data across all of ElephantDex. This entity tracks important things like total liquidity (in ONE and USD, see below), all time volume, transaction count, number of pairs and more.
